  ...
  fillContractTypeItems() {
    if (contractTypes.length % 2 == 0) {
      for (int i = 0; i < contractTypes.length; i += 2) {
        ...
        contractItem.topContractType = contractTypes[i].available.contractType;
        contractItem.bottomContractType = contractTypes[i + 1].available.contractType;
...
abstract class ContractTypeItem {
  ...
  String top;
  String bottom;
  String topContractType;
  String bottomContractType;
  String symbol;
